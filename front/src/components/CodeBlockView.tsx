...
import { ArrowLeftRight, Check, CodeXml, Copy, Download, Loader2 } from 'lucide-react';
...
export const CodeBlockView = memo(function CodeBlockView({
  ...
  return (
    <div
      ...
      {!isTxt && (
        <div
          ...
          <div className="flex items-center gap-2">
            ...
            <CodeXml size={16}
                     className={incomplete ? "text-blue-400" : (isDark ? "text-gray-100" : "text-gray-600")}/>
      ...
      {/* 代码内容 */}
      <div className={`overflow-x-auto prose-pre ${isTxt ? 'relative' : ''}`}>
        {/* txt 类型时在右上角显示复制按钮 */}
        {isTxt && (
